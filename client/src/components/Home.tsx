        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-500 mb-10 max-w-2xl leading-relaxed">
              AI Graduate Assistant specialized in <span className="text-dark font-medium underline decoration-primary/30 underline-offset-4">Agentic AI</span>, <span className="text-dark font-medium underline decoration-primary/30 underline-offset-4">Scalable Backend Systems</span>, and <span className="text-dark font-medium underline decoration-primary/30 underline-offset-4">Cloud Architecture</span>.
            </p>
